...
def fit_rarhmm(obs, act, nb_states):
    ...
    obs_prior = {'mu0': 0., 'sigma0': 1e16, 'nu0': dm_obs + 2, 'psi0': 1.}
    obs_mstep_kwargs = {'use_prior': False}

    trans_type = 'neural'
    trans_prior = {'l2_penalty': 0., 'alpha': 1, 'kappa': 25}
...
if __name__ == "__main__":
    ...
    save("rarhmm_cartpole_mse.tex")
    # save("gp_cartpole_mse.tex")
    # save("fnn_cartpole_mse.tex")
    # save("rnn_cartpole_mse.tex")
    # save("lstm_cartpole_mse.tex")
    plt.close()
    ...
    save("rarhmm_cartpole_evar.tex")
    # save("gp_cartpole_evar.tex")
    # save("fnn_cartpole_evar.tex")
    # save("rnn_cartpole_evar.tex")
    # save("lstm_cartpole_evar.tex")
    plt.close()
