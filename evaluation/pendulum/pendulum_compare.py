...
def fit_rarhmm(obs, act, nb_states):
    ...
    rarhmm.em(obs=obs, act=act,
              nb_iter=200, prec=1e-2, verbose=True,
...
if __name__ == "__main__":
    ...
    save("rarhmm_pendulum_mse.tex")
    # save("gp_pendulum_mse.tex")
    # save("fnn_pendulum_mse.tex")
    # save("rnn_pendulum_mse.tex")
    # save("lstm_pendulum_mse.tex")
    plt.close()
    ...
    save("rarhmm_pendulum_evar.tex")
    # save("gp_pendulum_evar.tex")
    # save("fnn_pendulum_evar.tex")
    # save("rnn_pendulum_evar.tex")
    # save("lstm_pendulum_evar.tex")
    plt.close()
