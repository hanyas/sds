...
if __name__ == "__main__":
    ...
    parser.add_argument('--nn_size', help='size of NN layer', default=16, type=int)
    parser.add_argument('--nb_states', help='number of linear components', default=2, type=int)
    ...
    if args.model == 'rarhmm':
        ...
        fnns = parallel_fnn_fit(obs=train_obs, act=train_act,
                                ...
                                preprocess=args.preprocess, nb_epochs=5000,
    ...
    save("bouncing_" + str(model_string) + "_mse.tex")
    plt.close()
    ...
    save("bouncing_" + str(model_string) + "_smse.tex")
    plt.close()
    ...
    save("bouncing_" + str(model_string) + "_evar.tex")
    plt.close()
